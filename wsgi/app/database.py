...
app.config['MONGO_DBNAME'] = os.environ['OPENSHIFT_APP_NAME'] # Setting the MONGO_DBNAME 
app.config['MONGO_URI'] = os.environ['OPENSHIFT_MONGODB_DB_URL']+os.environ['OPENSHIFT_APP_NAME'] # Setting MONGO_URI 
